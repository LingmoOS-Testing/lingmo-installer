...
from lingmo-installer import plugin
...
class WirelessPageBase(plugin.PluginUI):
    ...
    def plugin_skip_page(self):
        ...
        if 'LINGMO-INSTALLER_WIRELESS' in os.environ:
            return False

        from lingmo-installer import nm
...
class PageGtk(WirelessPageBase):
    plugin_title = 'lingmo-installer/text/wireless_heading_label'
    ...
    def __init__(self, controller, *args, **kwargs):
        ...
        if self.is_automatic:
            self.page = None
            return
        # Check whether we can talk to NM at all (e.g. debugging lingmo-installer
        ...
        builder.add_from_file(os.path.join(
            os.environ['LINGMO-INSTALLER_GLADE'], 'stepWireless.ui'))
    ...
    def plugin_translate(self, lang):
        ...
        self.connect_text = get_s('lingmo-installer/text/connect', lang)
        self.stop_text = get_s('lingmo-installer/text/stop', lang)
        ...
        frontend.status_label.set_text(self.controller.get_string(
            'lingmo-installer/text/connecting_label', lang))
...
class PageKde(WirelessPageBase):
    plugin_breadcrumb = 'lingmo-installer/text/breadcrumb_wireless'
    ...
    def _setup_page(self):
        ...
        from lingmo-installer.frontend.kde_components import nmwidgets
        self.nmwidget = nmwidgets.NetworkManagerWidget()
        self.nmwidget.state_changed.connect(self._update_ui)

        self.page = uic.loadUi('/usr/share/lingmo-installer/qt/stepWireless.ui')
    ...
    def plugin_translate(self, lang):
        ...
        for text in self.nmwidget.get_translation_keys():
            dct[text] = self.controller.get_string('lingmo-installer/text/' + text)
