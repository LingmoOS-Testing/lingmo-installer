...
# Written by Michael Vogt <michael.vogt@lingmo.com> and
...
MAGIC_MARKER = "/var/run/lingmo-installer.updated"
# Make sure that lingmo-installer is last, otherwise apt may try to install another
# frontend.
LINGMO-INSTALLER_PKGS = ["lingmo-installer-live",
                 "lingmo-installer-frontend-debconf",
                 "lingmo-installer-frontend-gtk",
                 "lingmo-installer-frontend-kde",
                 "lingmo-installer-lingmo-artwork",
                 "lingmo-installer"]
...
def update(frontend):
    ...
    try:
        ...
        cache = apt.Cache(cache_progress)
        cache_progress.really_done()
        updates = [pkg for pkg in LINGMO-INSTALLER_PKGS
