...
from lingmo-installer import keyboard_detector
...
class KeyboardQuery(Gtk.Window):
    ...
    def __init__(self, frontend):
        ...
        self.set_title(
            frontend.get_string('lingmo-installer/text/keyboard_query_title'))
        ...
        self.press_string = \
            frontend.get_string('lingmo-installer/text/keyboard_query_press')
        self.present_string = \
            frontend.get_string('lingmo-installer/text/keyboard_query_present')
