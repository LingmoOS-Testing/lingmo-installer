...
class PartitionModel(QtCore.QAbstractItemModel):
    def __init__(self, lingmo-installer, parent=None):
    ...
    def append(self, data, lingmo-installer):
        row = self.rowCount(QtCore.QModelIndex())
        self.beginInsertRows(QtCore.QModelIndex(), row, row)
        self.rootItem.appendChild(TreeItem(data, lingmo-installer, self.rootItem))
        self.endInsertRows()
