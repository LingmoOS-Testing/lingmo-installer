...
from lingmo-installer import i18n, misc
from lingmo-installer.frontend.kde_components.PartitionBar import PartitionsBar


_uidir = "/usr/share/lingmo-installer/qt/"
...
def addBars(parent, before_bar, after_bar):
    ...
    frame.layout().addWidget(QtWidgets.QLabel(
        get_string('lingmo-installer/text/partition_layout_before')))
    frame.layout().addWidget(before_bar)
    frame.layout().addWidget(QtWidgets.QLabel(
        get_string('lingmo-installer/text/partition_layout_after')))
