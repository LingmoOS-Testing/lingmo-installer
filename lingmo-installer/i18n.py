...
from lingmo-installer import im_switch, misc
            ...
            if name == b'name':
                ...
                if (use_langs is None or lang in use_langs or
                    ...
                    if question in ('grub-installer/bootdev',
                                    'partman-newworld/no_newworld',
                                    'lingmo-installer/text/error_updating_installer'):
...
string_questions = {
    ...
    'quit': 'lingmo-installer/imported/quit',
    'back': 'lingmo-installer/imported/go-back',
    'cancelbutton': 'lingmo-installer/imported/cancel',
    'exitbutton': 'lingmo-installer/imported/quit',
    'closebutton1': 'lingmo-installer/imported/close',
    'cancelbutton1': 'lingmo-installer/imported/cancel',
    'okbutton1': 'lingmo-installer/imported/ok',
}
...
def get_languages(current_language_index=-1, only_installable=False):
    ...
    languagelist = gzip.open(
        '/usr/lib/lingmo-installer/localechooser/languagelist.data.gz')
...
def default_locales():
    with open('/usr/lib/lingmo-installer/localechooser/languagelist') as languagelist:
        defaults = {}
        for line in languagelist:
            line = misc.utf8(line)
            if line == '' or line == '\n':
