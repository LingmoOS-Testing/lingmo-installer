...
from lingmo-installer.debconffilter import DebconfFilter
...
class UntrustedBase(object):
    ...
    def debug_enabled(*args):
        return ('LINGMO-INSTALLER_DEBUG_CORE' in os.environ and
                os.environ['LINGMO-INSTALLER_DEBUG_CORE'] == '1')
    ...
    def is_automatic(self):
        ...
        """
        return "LINGMO-INSTALLER_AUTOMATIC" in os.environ


class FilteredCommand(UntrustedBase):
    def __init__(self, frontend, db=None, ui=None):
        self.frontend = frontend  # lingmo-installer-wide UI
