...
from lingmo_installer import plugin
...
class WirelessPageBase(plugin.PluginUI):
    ...
    def plugin_skip_page(self):
        ...
        if 'LINGMO_INSTALLER_WIRELESS' in os.environ:
            return False

        from lingmo_installer import nm
...
class PageGtk(WirelessPageBase):
    plugin_title = 'lingmo_installer/text/wireless_heading_label'
    ...
    def __init__(self, controller, *args, **kwargs):
        ...
        if self.is_automatic:
            self.page = None
            return
        # Check whether we can talk to NM at all (e.g. debugging lingmo_installer
        ...
        builder.add_from_file(os.path.join(
            os.environ['LINGMO_INSTALLER_GLADE'], 'stepWireless.ui'))
    ...
    def plugin_translate(self, lang):
        ...
        self.connect_text = get_s('lingmo_installer/text/connect', lang)
        self.stop_text = get_s('lingmo_installer/text/stop', lang)
        ...
        frontend.status_label.set_text(self.controller.get_string(
            'lingmo_installer/text/connecting_label', lang))
...
class PageKde(WirelessPageBase):
    plugin_breadcrumb = 'lingmo_installer/text/breadcrumb_wireless'
    ...
    def _setup_page(self):
        ...
        from lingmo_installer.frontend.kde_components import nmwidgets
        self.nmwidget = nmwidgets.NetworkManagerWidget()
        self.nmwidget.state_changed.connect(self._update_ui)

        self.page = uic.loadUi('/usr/share/lingmo_installer/qt/stepWireless.ui')
    ...
    def plugin_translate(self, lang):
        ...
        for text in self.nmwidget.get_translation_keys():
            dct[text] = self.controller.get_string('lingmo_installer/text/' + text)
