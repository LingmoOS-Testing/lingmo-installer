...
from lingmo_installer import i18n, misc, plugin
import lingmo_installer.tz
...
class PageGtk(plugin.PluginUI):
    plugin_title = 'lingmo_installer/text/timezone_heading_label'
    ...
    def __init__(self, controller, *args, **kwargs):
        ...
        builder.add_from_file(os.path.join(
            os.environ['lingmo_installer_GLADE'], 'stepLocation.ui'))
    ...
    def plugin_translate(self, lang):
        # c = self.controller
        # if c.get_string('lingmo_installer/imported/time-format', lang) == '12-hour':
        #    fmt = c.get_string('lingmo_installer/imported/12-hour', lang)
        # else:
        #    fmt = c.get_string('lingmo_installer/imported/24-hour', lang)
    ...
    def changed(self, entry):
        ...
        if text in self.geoname_cache:
            ...
            message.request_headers.append('User-agent', 'Lingmo_installer/1.0')
    ...
    def setup_page(self):
        ...
        self.tzdb = lingmo_installer.tz.Database()
...
class PageKde(plugin.PluginUI):
    plugin_breadcrumb = 'lingmo_installer/text/breadcrumb_timezone'
    ...
    def __init__(self, controller, *args, **kwargs):
        ...
        try:
            ...
            self.page = uic.loadUi('/usr/share/lingmo_installer/qt/stepLocation.ui')
...
class Page(plugin.Plugin):
    def prepare(self, unfiltered=False):
        ...
        clock_script = '/usr/share/lingmo_installer/clock-setup'
        env = {'PATH': '/usr/share/lingmo_installer:' + os.environ['PATH']}

        # TODO: replace with more general version pushed down into
        # is_automatic or similar
        try:
            self.automatic_page = (
                self.db.get("lingmo_installer/automatic/timezone") == "true")
...
class Install(plugin.InstallPlugin):
    def prepare(self, unfiltered=False):
        tzsetup_script = '/usr/lib/lingmo_installer/tzsetup/post-base-installer'
        clock_script = '/usr/share/lingmo_installer/clock-setup-apply'
    ...
    def install(self, target, progress, *args, **kwargs):
        progress.info('lingmo_installer/install/timezone')
