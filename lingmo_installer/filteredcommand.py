...
from lingmo_installer.debconffilter import DebconfFilter


# We identify as this to debconf.
PACKAGE = 'lingmo_installer'
...
class UntrustedBase(object):
    ...
    def debug_enabled(*args):
        return ('LINGMO_INSTALLER_DEBUG_CORE' in os.environ and
                os.environ['LINGMO_INSTALLER_DEBUG_CORE'] == '1')
    ...
    def is_automatic(self):
        ...
        """
        return "LINGMO_INSTALLER_AUTOMATIC" in os.environ


class FilteredCommand(UntrustedBase):
    def __init__(self, frontend, db=None, ui=None):
        self.frontend = frontend  # lingmo_installer-wide UI
