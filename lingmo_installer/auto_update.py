...
MAGIC_MARKER = "/var/run/lingmo_installer.updated"
# Make sure that lingmo_installer is last, otherwise apt may try to install another
# frontend.
LINGMO_INSTALLER_PKGS = ["lingmo_installer-live",
                         "lingmo_installer-frontend-debconf",
                         "lingmo_installer-frontend-gtk",
                         "lingmo_installer-frontend-kde",
                         "lingmo_installer-lingmo-artwork",
                         "lingmo_installer"]
...
def update(frontend):
    ...
    try:
        ...
        cache = apt.Cache(cache_progress)
        cache_progress.really_done()
        updates = [pkg for pkg in LINGMO_INSTALLER_PKGS
