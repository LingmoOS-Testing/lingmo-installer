...
# frontend; the main lingmo_installer program takes care of this.
...
from lingmo_installer import misc, i18n, telemetry
from lingmo_installer.components import install, plugininstall
from lingmo_installer.frontend.base import BaseFrontend, Controller
...
class Wizard(BaseFrontend):
    def __init__(self, distro):
        ...
        if self.oem_user_config:
            self.db.info('lingmo_installer/text/oem_user_config_title')
        else:
            self.db.info('lingmo_installer/text/live_installer')
