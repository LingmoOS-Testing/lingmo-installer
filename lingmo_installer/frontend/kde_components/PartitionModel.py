...
class PartitionModel(QtCore.QAbstractItemModel):
    def __init__(self, lingmo_installer, parent=None):
    ...
    def append(self, data, lingmo_installer):
        row = self.rowCount(QtCore.QModelIndex())
        self.beginInsertRows(QtCore.QModelIndex(), row, row)
        self.rootItem.appendChild(TreeItem(data, lingmo_installer, self.rootItem))
        self.endInsertRows()
