...
from lingmo_installer import im_switch, misc
            ...
            if name == b'name':
                ...
                if (use_langs is None or lang in use_langs or
                    ...
                    if question in ('grub-installer/bootdev',
                                    'partman-newworld/no_newworld',
                                    'lingmo_installer/text/error_updating_installer'):
...
string_questions = {
    ...
    'quit': 'lingmo_installer/imported/quit',
    'back': 'lingmo_installer/imported/go-back',
    'cancelbutton': 'lingmo_installer/imported/cancel',
    'exitbutton': 'lingmo_installer/imported/quit',
    'closebutton1': 'lingmo_installer/imported/close',
    'cancelbutton1': 'lingmo_installer/imported/cancel',
    'okbutton1': 'lingmo_installer/imported/ok',
}
...
def get_languages(current_language_index=-1, only_installable=False):
    ...
    languagelist = gzip.open(
        '/usr/lib/lingmo_installer/localechooser/languagelist.data.gz')
...
def default_locales():
    with open('/usr/lib/lingmo_installer/localechooser/languagelist') as languagelist:
        defaults = {}
        for line in languagelist:
            line = misc.utf8(line)
            if line == '' or line == '\n':
