...
from lingmo-installer import nm, plugin_manager


class WirelessTests(unittest.TestCase):
    @mock.patch('lingmo-installer.nm.NetworkManager.start')
    @mock.patch('lingmo-installer.nm.NetworkManager.get_state')
    @mock.patch('lingmo-installer.misc.has_connection')
