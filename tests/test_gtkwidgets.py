...
class NetworkStoreTests(unittest.TestCase):
    ...
    def test_has_device(self):
        ...
        self.assertTrue(self.model.has_device('/foo'))
        self.assertTrue(not self.model.has_device('/not-there'))
    ...
    def test_has_ap(self):
        ...
        self.assertTrue(self.model.has_ap('/foo', 'Orange'))
        self.assertTrue(not self.model.has_ap('/not-there', 'Orange'))
        self.assertTrue(not self.model.has_ap('/foo', 'Aubergine'))
...
class NetworkManagerTests(unittest.TestCase):
    ...
    def test_decode_ssid(self):
        ...
        self.assertEqual(nm.decode_ssid(ssid), 'Lingmo-Battersea')
