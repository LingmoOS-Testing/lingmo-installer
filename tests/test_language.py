...
class LanguageTests(unittest.TestCase):
    def setUp(self):
        ...
        # the Try Lingmo button with the appropriate action.
        with EnvironmentVarGuard() as environ:
            environ['LINGMO-INSTALLER_GREETER'] = '1'
    ...
    def test_try_lingmo_clicks(self):
        ...
        # Multiple clicks on Try Lingmo crash the installer.  LP: #911907
        self.gtk.try_lingmo.clicked()
        self.gtk.try_lingmo.clicked()
        # Process the clicks.
        gtkwidgets.refresh()
        # When the Try Lingmo button is clicked, the dbfilter's ok_handler()
