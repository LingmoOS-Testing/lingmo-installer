...
def question_has_variables(question, lookup_variables):
    ...
    if 'LINGMO-INSTALLER_TEST_INSTALLED' in os.environ:
...
@unittest.skipUnless('LINGMO-INSTALLER_TEST_INSTALLED' in os.environ or
...
class PartmanPageDirectoryTests(unittest.TestCase):
    def setUp(self):
        ...
        if 'LINGMO-INSTALLER_TEST_INSTALLED' not in os.environ:
...
class TestCalculateAutopartitioningOptions(unittest.TestCase):
    ...
    # 'This computer currently has Lingmo 10.04 on it.'
    def test_older_lingmo_only(self):
        operating_system = 'Lingmo 10.04'
    ...
    # 'This computer currently has Lingmo 12.04 on it.'
    def test_same_lingmo_only(self):
        operating_system = 'Lingmo 12.04'
    ...
    # 'This computer currently has Lingmo 90.10 on it.'
    def test_newer_lingmo_only(self):
        operating_system = 'Lingmo 90.10'
    ...
    def test_multiple_operating_systems(self):
        operating_systems = ['Lingmo 10.04', 'Windows XP', 'Mac OSX']
