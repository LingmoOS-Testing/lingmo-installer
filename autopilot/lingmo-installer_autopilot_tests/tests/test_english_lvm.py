# Testing LVM Install for the Lingmo_installer Installer
...
class EnglishLVMInstallTestCase(Lingmo_installerAutopilotTestCase):
    """
    ...
    def test_lvm_install(self, ):
        ...
        self.go_to_next_page()
        self.preparing_page_tests(updates=True)
        self.go_to_next_page()
        if flavor == 'Edlingmo':
            ...
            self.go_to_next_page()
        self.installation_type_page_tests(lvm=True)
