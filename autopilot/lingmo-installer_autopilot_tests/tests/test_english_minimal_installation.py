# Testing Default Install for the Lingmo-installer Installer
...
class EnglishMinimalInstallationTestCase(Lingmo-installerAutopilotTestCase):
    """
    Test choosing English and minimal installation option
    """
    ...
    def test_default_install(self, ):
        ...
        self.go_to_next_page()
        if flavor == 'Edlingmo':
            self.edlingmo_addon_window_tests(gnome=True)
            self.go_to_next_page()
